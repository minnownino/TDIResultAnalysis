...
#' @param tumorset a given tumor set
...
identify.driverAssociatedDEGlist.giventumorset <- function(driverlist, drivercallmatrix, TDIresults, postprobnoiselv, tumorset, numoftargenes.cutoff = 5, DEGcallrate.thd = 0.2) {
  
  # Update the TDIresult and drivercallmatrix by filtering the tumor set
  idx2keep.tdiresults = which(is.element(TDIresults[, "patient_name"], tumorset)>0)
  TDIresults = TDIresults[idx2keep.tdiresults, ]
  drivercallmatrix = drivercallmatrix[tumorset, ]
